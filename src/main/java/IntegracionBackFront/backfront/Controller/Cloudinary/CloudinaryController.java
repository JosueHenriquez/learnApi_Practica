    ...
    public ResponseEntity<?> uploadImage(@RequestParam("image")MultipartFile file){
        try {
            ...
            return ResponseEntity.ok(Map.of(
                    ...
                    "url", imageUrl
                    //la api le va a devolver un mensaje y una variable, la variable va a obtener la url de la imagen,
                    // en el frontend hay que mandar a llamar la variable "URL" por que es quien almacena la imagen
            ));
        } catch (IOException e) {
